...
Alabama_Expenditures <- expenditures %>% filter(States == "Alabama_Expenditures")
...
Alaska_Expenditures <- expenditures %>% filter(States == "Alaska_Expenditures")
...
Arizona_Expenditures <- expenditures %>% filter(States == "Arizona_Expenditures")
...
Colorado_Expenditures <- expenditures %>% filter(States == "Colorado_Expenditures")
...
Connecticut_Expenditures <- expenditures %>% filter(States == "Connecticut_Expenditures")
...
Delaware_Expenditures <- expenditures %>% filter(States == "Delaware_Expenditures")
...
Illinois_Expenditures <- expenditures %>% filter(States == "Illinois_Expenditures")
...
Indiana_Expenditures <- expenditures %>% filter(States == "Indiana_Expenditures")
...
Louisiana_Expenditures <- expenditures %>% filter(States == "Louisiana_Expenditures")
...
Maine_Expenditures <- expenditures %>% filter(States == "Maine_Expenditures")
...
Maryland_Expenditures <- expenditures %>% filter(States == "Maryland_Expenditures")
...
Missouri_Expenditures <- expenditures %>% filter(States == "Missouri_Expenditures")
...
Nebraska_Expenditures <- expenditures %>% filter(States == "Nebraska_Expenditures")
...
`North Carolina_Expenditures` <- expenditures %>% filter(States == "North Carolina_Expenditures")
...
`North Dakota_Expenditures` <- expenditures %>% filter(States == "North Dakota_Expenditures")
...
Oklahoma_Expenditures <- expenditures %>% filter(States == "Oklahoma_Expenditures")
...
`Rhode Island_Expenditures` <- expenditures %>% filter(States == "Rhode Island_Expenditures")
...
Texas_Expenditures <- expenditures %>% filter(States == "Texas_Expenditures")
...
Vermont_Expenditures <- expenditures %>% filter(States == "Vermont_Expenditures")
...
`West Virginia_Expenditures` <- expenditures %>% filter(States == "West Virginia_Expenditures")
...
Wyoming_Expenditures <- expenditures %>% filter(States == "Wyoming_Expenditures")
