...
adm18 <- read_xlsx("data/Data for web team 2021 v5.xlsx", sheet = "Admissions 2018", .name_repair = "universal")
adm19 <- read_xlsx("data/Data for web team 2021 v5.xlsx", sheet = "Admissions 2019", .name_repair = "universal")
adm20 <- read_xlsx("data/Data for web team 2021 v5.xlsx", sheet = "Admissions 2020", .name_repair = "universal")
